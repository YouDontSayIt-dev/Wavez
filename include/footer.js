class Footer extends HTMLElement {
    ...
    connectedCallback(){
        ...
        <div class="flex flex-row flex-wrap font-normal text-lg mt-auto h-80">
            <div class="flex flex-row items-center">
                ...
                <!-- SOCIAL ICONS -->
                <div class="flex items-start flex-grow justify-end pr-6">
                    <button class="w-15 h-15 my-3 mx-3 bg-custom-color-footer-social-icons rounded-full flex items-center justify-center">
                        <a href="exp.html" class="w-45px h-45px ">
                    ...
                    <button class="w-15 h-15 my-3 mx-3 bg-custom-color-footer-social-icons rounded-full flex items-center justify-center">
                        <a href="exp.html" class="w-9 h-9 mb-1.5">
                    ...
                    <!-- <a href="exp.html" class="w-11 h-11 py-3 mx-3 my-3 bg-custom-color-footer-social-icons rounded-full flex items-center justify-center focus:outline-none">
                        <img src="/assets/vectorFB.png" alt="">
                    </a> -->
                </div>
        </footer>
        `;
